...
public class UriFactory {
	...
	public class Users {
		...
		public static final String GET_RECENT_MEDIA = UriFactory.API_ROOT + "/users/self/media/recent";
	...
	public class Auth {
		public static final String USER_AUTHORIZATION = "https://www.instagram.com/accounts/login/?next=/oauth/authorize/&";
